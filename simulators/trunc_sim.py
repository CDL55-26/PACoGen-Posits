...
def comp_trunc16(int_val,es):
    ...
    if percent_error <= 0.15:   
        print(f'Es = {es}, Original Decimal: {int_val:4f}, 8-bit Rep: {dec_8b}, 16-bit Rep: {dec_16b}, Percent Error: {percent_error:4f}')
        print(f'8-Bit rep: {pos_8b},16-bit Rep: {pos_16b}\n')
    else:
